...
const listDetails = ['Casual Style', 'Heart Pattern', 'Heart Pattern', '100% Polyester', 'Product code: HS0976', 'Fabric'];
      ...
      <div className="flex flex-col flex-wrap justify-start items-start h-64 gap-11 mt-14 mb-16 w-fit">
        {listDetails.map((item, idx) =>
          <div className="flex flex-row items-center" key={idx}>
            ...
            <Heading6 className="ml-2.5 font-poppins">{item}</Heading6>
          </div>
        )}
      </div>
    </div>
