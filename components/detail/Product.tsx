  ...
  return (
    <div className='flex flex-row items-stretch justify-between mt-16'>
      <div className='flex flex-row items-center justify-center w-[48%]'>
        {/* <Image src={hoodie} alt="image product" /> */}
        <Zoom
          img='https://m.media-amazon.com/images/I/6160rBUSiHL._AC_UX385_.jpg'
          zoomScale={3}
          className='h-[553px] rounded'
          height={600}
          width={600}
          transitionTime={0.5}
        />
        <div className="flex flex-col justify-start items-center w-[14%]">
          <Image className='w-full cursor-pointer' src={hoodie} alt="image product" width={91} />
          <Image className='w-full cursor-pointer' src={hoodie} alt="image product" width={91} />
          <Image className='w-full cursor-pointer' src={hoodie} alt="image product" width={91} />
          <Image className='w-full cursor-pointer' src={hoodie} alt="image product" width={91} />
          <Image className='w-full cursor-pointer' src={hoodie} alt="image product" width={91} />
      ...
      <div className="flex flex-col justify-center items-start w-[48%]">
        ...
        <div className='flex flex-row items-center justify-start my-12'>
        ...
        <div className='flex flex-row items-center justify-start mt-12 mb-11'>
        ...
        <div className="flex flex-col items-start justify-center">
          <div className="flex flex-row items-center justify-start">
            ...
            <SubTitle2 className="text-[#424242B2] ml-3 !font-poppins">Free Shipping</SubTitle2>
          </div>
          <div className="flex flex-row items-center mt-4 justify-start">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3.11 16.44V21.44V16.44Z" fill="#008A04" />
              <path d="M22 12C22 17.52 17.52 22 12 22C6.48 22 3.11 16.44 3.11 16.44M3.11 16.44H7.63M3.11 16.44V21.44M2 12C2 6.48 6.44 2 12 2C18.67 2 22 7.56 22 7.56M22 7.56V2.56M22 7.56H17.56" stroke="#008A04" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <SubTitle2 className="text-[#424242B2] ml-3 !font-poppins">10 days return policy</SubTitle2>
          </div>
        </div>
        <div className="flex flex-row items-center justify-between mt-12 w-full">
          ...
          >
            ...
            <SubTitle2 className="text-[#FFFFFF] text-sm ml-1">Add To Cart</SubTitle2>
          </ButtonWithIcon>
          <ButtonWithIcon
          ...
          >
            ...
            <SubTitle2 className="text-[#424242] text-sm ml-1">Add to Favorites</SubTitle2>
          </ButtonWithIcon>
        </div>
      </div>
    </div>
